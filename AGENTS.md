...
Unit 9 ("The Science of Fun") is in progress — opener, vocab-1, song, grammar-1, vocab-2, grammar-2, reading, and writing have teacher + learner pairs; mission, project, and book-reading are teacher decks only so far (no Leo app yet). The Units 7-9 checkpoint band also has its two teacher decks: Review 7-9 and Extra Reading 7-9 (Leonardo da Vinci). Remaining for this unit: the Leo apps for mission, project, book-reading, review, and extra-reading, per `docs/build-order.md`.
