...
Unit 9 ("The Science of Fun") is complete as a unit — opener, vocab-1, song, grammar-1, vocab-2, grammar-2, reading, writing, mission, project, and book-reading all have teacher + learner pairs. The Units 7-9 checkpoint band has its two teacher decks (Review 7-9 and Extra Reading 7-9, Leonardo da Vinci). Review 7-9 now has its Leo app too; the Extra Reading app is the last thing outstanding for the band, per `docs/build-order.md`.
