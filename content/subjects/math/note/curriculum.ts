...
export const mathNoteChapters: MathNoteChapterMeta[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      section("1", 3, 3, "加法", "p.16–17", { textbookRef: "教 P.30〜32", authored: true, scanned: true }),
      ...
      section("1", 7, 7, "乗法", "p.26–27", { textbookRef: "教 P.42〜46", authored: true, scanned: true }),
      section("1", 8, 8, "累乗", "p.28", { textbookRef: "教 P.47", authored: true, scanned: true }),
      section("1", 9, 9, "除法", "p.29", { textbookRef: "教 P.48〜49", authored: true, scanned: true }),
      section("1", 10, 10, "除法と逆数", "p.30", { textbookRef: "教 P.50〜51", authored: true, scanned: true }),
      section("1", 11, 11, "乗法と除法の混じった計算", "p.31", { textbookRef: "教 P.51", authored: true, scanned: true }),
      section("1", 12, 12, "四則の混じった計算", "p.32–33", { textbookRef: "教 P.52〜53", authored: true, scanned: true }),
  ...
  },
  {
    ...
    sections: [
      ...
      section("2", 5, 5, "項と係数　1次式の加法，減法", "p.48–49", { textbookRef: "教 P.76〜78", authored: true, scanned: true }),
      section("2", 6, 6, "1次式と数の乗法，除法(1)", "p.50–51", { textbookRef: "教 P.79〜81", authored: true, scanned: true }),
      section("2", 7, 7, "1次式と数の乗法，除法(2)", "p.52", { textbookRef: "教 P.81", authored: true, scanned: true }),
      section("2", 8, 8, "文字式の利用", "p.53", { textbookRef: "教 P.83〜85", authored: true, scanned: true }),
      ...
      section("2", null, "drill4", "特訓ドリル④　1次式の計算", "p.54–55", { authored: true, scanned: true }),
      section("2", 9, 9, "数量の間の関係の表し方", "p.56–57", { textbookRef: "教 P.86〜87", authored: true, scanned: true }),
      section("2", null, "test", "確認テスト・C問題・考えてみよう", "p.58–61", { authored: true, scanned: true })
    ]
  },
  {
    key: "3",
