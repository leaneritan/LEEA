...
| book-reading | `public/lessons/ow-l4-u9-book-reading.html` | `public/learn/ow-l4-u9-book-reading.html` | `live` (6-module) |
...
| extra-reading | `public/lessons/ow-l4-er7-9-extra-reading.html` | `public/learn/ow-l4-er7-9-extra-reading.html` | `live` (8-module) |
| lets-talk | `public/lessons/ow-l4-lt7-9-lets-talk.html` | `public/learn/ow-l4-lt7-9-lets-talk.html` | `live` (6-module) |
...
## No doc unless something reads it

Per-lesson design docs (`grammar-1.design.md`, `writing.design.md`, etc.) were originally written as seed material to extract reusable skills (`/grammar-app`, `/reading-app`, etc.). Once the skill exists, the design doc has no active reader and becomes documentation rot.
