    ...
    <div className="design-home">
      ...
      <section className="design-subjects">
        ...
        <div className="design-subject-grid">
          ...
          <Link className="subject-card active" href="/science"><div><span>Active</span><b>🔬</b></div><h3>Science</h3><p>新編 新しい科学1 — 中1・4単元13章, with an AI tutor chat.</p><footer><span>13 chapters</span><span>単元1 第1章</span></footer></Link>
