...
import {
  level3Unit7AcademicItems,
  level3Unit7GlossaryItems,
  level3Unit7Vocab1Items,
  level3Unit7Vocab2Items
} from "@/data/reference";
...
const unitSections: Section[] = [
  {
    id: "vocab1",
    title: "Vocabulary 1",
    sub: "Body parts, muscles, bend & stretch",
    icon: "①",
    accent: "var(--good)",
    tint: "var(--good-tint)",
    words: level3Unit7Vocab1Items.map(toWordEntry)
  },
  {
    id: "vocab2",
    title: "Vocabulary 2",
    sub: "Exercise, fruits, vegetables & resting",
    icon: "②",
    accent: "#2f9c8e",
    tint: "#e6f4f1",
    words: level3Unit7Vocab2Items.map(toWordEntry)
  },
  {
    id: "academic",
    title: "Academic",
    ...
    words: level3Unit7AcademicItems.map(toWordEntry)
  },
  {
    id: "glossary",
    title: "Glossary",
    ...
    accent: "var(--muted-2)",
    tint: "#f0f1ec",
    words: level3Unit7GlossaryItems.map(toWordEntry)
  }
].filter(s => s.words.length > 0);

const unitGrammarEntries = allGrammar
  .filter((g) => g.course === "our-world" && g.level === 3 && g.unit === 7)
...
export default function UnitReference37() {
  return (
          ...
          <div className="unit-hero-left">
            ...
            <div>
              <div className="unit-hero-eyebrow-row">
                <span className="unit-hero-eyebrow">Our World · Level 3 · Unit 7</span>
              </div>
              <h1 className="unit-hero-title">Feeling Fit</h1>
            </div>
          </div>
