...
import {
  level3Unit9AcademicItems,
  level3Unit9GlossaryItems,
  level3Unit9Vocab1Items,
  level3Unit9Vocab2Items
} from "@/data/reference";
...
const unitSections: Section[] = [
  {
    id: "vocab1",
    title: "Vocabulary 1",
    sub: "Free-time activities & song words",
    icon: "①",
    accent: "var(--good)",
    tint: "var(--good-tint)",
    words: level3Unit9Vocab1Items.map(toWordEntry)
  },
  {
    id: "vocab2",
    title: "Vocabulary 2",
    sub: "Outdoor & leisure activities",
    icon: "②",
    accent: "#2f9c8e",
    tint: "#e6f4f1",
    words: level3Unit9Vocab2Items.map(toWordEntry)
  },
  {
    id: "academic",
    title: "Academic",
    ...
    words: level3Unit9AcademicItems.map(toWordEntry)
  },
  {
    id: "glossary",
    title: "Glossary",
    ...
    accent: "var(--muted-2)",
    tint: "#f0f1ec",
    words: level3Unit9GlossaryItems.map(toWordEntry)
  }
].filter(s => s.words.length > 0);

const unitGrammarEntries = allGrammar
  .filter((g) => g.course === "our-world" && g.level === 3 && g.unit === 9)
...
export default function UnitReference39() {
  return (
          ...
          <div className="unit-hero-left">
            ...
            <div>
              <div className="unit-hero-eyebrow-row">
                <span className="unit-hero-eyebrow">Our World · Level 3 · Unit 9</span>
              </div>
              <h1 className="unit-hero-title">My Weekend</h1>
            </div>
          </div>
