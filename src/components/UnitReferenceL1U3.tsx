...
import {
  level1Unit3Vocab1Items,
  level1Unit3Vocab2Items,
  level1Unit3AcademicItems,
  level1Unit3GlossaryItems
} from "@/data/reference";
...
const unitSections: Section[] = [
  {
    ...
    accent: "var(--good)",
    tint: "var(--good-tint)",
    words: level1Unit3Vocab1Items.map(toWordEntry)
  },
  {
    id: "vocab2",
    title: "Vocabulary 2",
    ...
    accent: "#2f9c8e",
    tint: "#e6f4f1",
    words: level1Unit3Vocab2Items.map(toWordEntry)
  },
  {
    id: "academic",
    title: "Academic",
    ...
    words: level1Unit3AcademicItems.map(toWordEntry)
  },
  {
    id: "glossary",
    title: "Glossary",
    ...
    accent: "var(--muted-2)",
    tint: "#f0f1ec",
    words: level1Unit3GlossaryItems.map(toWordEntry)
  }
].filter(s => s.words.length > 0);

const unitGrammarEntries = allGrammar
  .filter((g) => g.course === "our-world" && g.level === 1 && g.unit === 3)
...
export default function UnitReferenceL1U3() {
  return (
          ...
          <div className="unit-hero-left">
            ...
            <div>
              <div className="unit-hero-eyebrow-row">
                <span className="unit-hero-eyebrow">Our World · Level 1 · Unit 3</span>
              </div>
              <h1 className="unit-hero-title">My Family</h1>
            </div>
          </div>
