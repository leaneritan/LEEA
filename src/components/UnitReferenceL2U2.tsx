...
import {
  level2Unit2Vocab1Items,
  level2Unit2Vocab2Items,
  level2Unit2AcademicItems,
  level2Unit2GlossaryItems
} from "@/data/reference";
...
const unitSections: Section[] = [
  {
    ...
    accent: "var(--good)",
    tint: "var(--good-tint)",
    words: level2Unit2Vocab1Items.map(toWordEntry)
  },
  {
    id: "vocab2",
    title: "Vocabulary 2",
    ...
    accent: "#2f9c8e",
    tint: "#e6f4f1",
    words: level2Unit2Vocab2Items.map(toWordEntry)
  },
  {
    id: "academic",
    title: "Academic",
    ...
    words: level2Unit2AcademicItems.map(toWordEntry)
  },
  {
    id: "glossary",
    title: "Glossary",
    ...
    accent: "var(--muted-2)",
    tint: "#f0f1ec",
    words: level2Unit2GlossaryItems.map(toWordEntry)
  }
].filter((s) => s.words.length > 0);

const unitGrammarEntries = allGrammar
  .filter((g) => g.course === "our-world" && g.level === 2 && g.unit === 2)
...
export default function UnitReferenceL2U2() {
  return (
    <AppShell active="reference" crumbs={["Reference", "Our World", "Level 2", "Unit 2"]}>
          ...
          <div className="unit-hero-left">
            ...
            <div>
              <div className="unit-hero-eyebrow-row">
                <span className="unit-hero-eyebrow">Our World · Level 2 · Unit 2</span>
              </div>
              <h1 className="unit-hero-title">Boots and Bathing Suits</h1>
            </div>
          </div>
