...
import {
  level2Unit5Vocab1Items,
  level2Unit5Vocab2Items,
  level2Unit5AcademicItems,
  level2Unit5GlossaryItems
} from "@/data/reference";
...
const unitSections: Section[] = [
  {
    ...
    accent: "var(--good)",
    tint: "var(--good-tint)",
    words: level2Unit5Vocab1Items.map(toWordEntry)
  },
  {
    id: "vocab2",
    title: "Vocabulary 2",
    ...
    accent: "#2f9c8e",
    tint: "#e6f4f1",
    words: level2Unit5Vocab2Items.map(toWordEntry)
  },
  {
    id: "academic",
    title: "Academic",
    ...
    words: level2Unit5AcademicItems.map(toWordEntry)
  },
  {
    id: "glossary",
    title: "Glossary",
    ...
    accent: "var(--muted-2)",
    tint: "#f0f1ec",
    words: level2Unit5GlossaryItems.map(toWordEntry)
  }
].filter((s) => s.words.length > 0);

const unitGrammarEntries = allGrammar
  .filter((g) => g.course === "our-world" && g.level === 2 && g.unit === 5)
...
export default function UnitReferenceL2U5() {
  return (
    <AppShell active="reference" crumbs={["Reference", "Our World", "Level 2", "Unit 5"]}>
          ...
          <div className="unit-hero-left">
            ...
            <div>
              <div className="unit-hero-eyebrow-row">
                <span className="unit-hero-eyebrow">Our World · Level 2 · Unit 5</span>
              </div>
              <h1 className="unit-hero-title">Day by Day</h1>
            </div>
          </div>
