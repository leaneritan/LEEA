...
import {
  level2Unit8Vocab1Items,
  level2Unit8Vocab2Items,
  level2Unit8AcademicItems,
  level2Unit8GlossaryItems
} from "@/data/reference";
...
const unitSections: Section[] = [
  {
    ...
    accent: "var(--good)",
    tint: "var(--good-tint)",
    words: level2Unit8Vocab1Items.map(toWordEntry)
  },
  {
    id: "vocab2",
    title: "Vocabulary 2",
    ...
    accent: "#2f9c8e",
    tint: "#e6f4f1",
    words: level2Unit8Vocab2Items.map(toWordEntry)
  },
  {
    id: "academic",
    title: "Academic",
    ...
    words: level2Unit8AcademicItems.map(toWordEntry)
  },
  {
    id: "glossary",
    title: "Glossary",
    ...
    accent: "var(--muted-2)",
    tint: "#f0f1ec",
    words: level2Unit8GlossaryItems.map(toWordEntry)
  }
].filter(s => s.words.length > 0);

const unitGrammarEntries = allGrammar
  .filter((g) => g.course === "our-world" && g.level === 2 && g.unit === 8)
...
export default function UnitReferenceL2U8() {
  return (
    <AppShell active="reference" crumbs={["Reference", "Our World", "Level 2", "Unit 8"]}>
          ...
          <div className="unit-hero-left">
            ...
            <div>
              <div className="unit-hero-eyebrow-row">
                <span className="unit-hero-eyebrow">Our World · Level 2 · Unit 8</span>
              </div>
              <h1 className="unit-hero-title">The World of Work</h1>
            </div>
          </div>
