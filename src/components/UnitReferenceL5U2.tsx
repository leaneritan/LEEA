...
import {
  level5Unit2AcademicItems,
  level5Unit2GlossaryItems,
  level5Unit2Vocab1Items,
  level5Unit2Vocab2Items
} from "@/data/reference";
...
const unitSections: Section[] = [
  {
    ...
    accent: "var(--good)",
    tint: "var(--good-tint)",
    words: level5Unit2Vocab1Items.map(toWordEntry)
  },
  {
    id: "vocab2",
    title: "Vocabulary 2",
    ...
    accent: "#2f9c8e",
    tint: "#e6f4f1",
    words: level5Unit2Vocab2Items.map(toWordEntry)
  },
  {
    id: "academic",
    title: "Academic",
    ...
    words: level5Unit2AcademicItems.map(toWordEntry)
  },
  {
    id: "glossary",
    title: "Glossary",
    ...
    accent: "var(--muted-2)",
    tint: "#f0f1ec",
    words: level5Unit2GlossaryItems.map(toWordEntry)
  }
];

const unitGrammarEntries = allGrammar
  .filter((g) => g.course === "our-world" && g.level === 5 && g.unit === 2)
...
export default function UnitReferenceL5U2() {
  return (
    <AppShell active="reference" crumbs={["Reference", "Our World", "Level 5", "Unit 2"]}>
          ...
          <div className="unit-hero-left">
            ...
            <div>
              <div className="unit-hero-eyebrow-row">
                <span className="unit-hero-eyebrow">Our World · Level 5 · Unit 2</span>
              </div>
              <h1 className="unit-hero-title">Copycat Animals</h1>
            </div>
          </div>
