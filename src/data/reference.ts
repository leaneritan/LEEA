...
import level5Unit2Vocabulary from "../../content/subjects/english/courses/our-world/level-5/unit-2/vocabulary.json";
...
import level1Unit5Vocabulary from "../../content/subjects/english/courses/our-world/level-1/unit-5/vocabulary.json";
import level1Unit6Vocabulary from "../../content/subjects/english/courses/our-world/level-1/unit-6/vocabulary.json";
import level1Unit7Vocabulary from "../../content/subjects/english/courses/our-world/level-1/unit-7/vocabulary.json";
import level1Unit8Vocabulary from "../../content/subjects/english/courses/our-world/level-1/unit-8/vocabulary.json";
import level1Unit9Vocabulary from "../../content/subjects/english/courses/our-world/level-1/unit-9/vocabulary.json";
...
import level2Unit4Vocabulary from "../../content/subjects/english/courses/our-world/level-2/unit-4/vocabulary.json";
import level2Unit9Vocabulary from "../../content/subjects/english/courses/our-world/level-2/unit-9/vocabulary.json";
import level2Unit8Vocabulary from "../../content/subjects/english/courses/our-world/level-2/unit-8/vocabulary.json";
import level2Unit7Vocabulary from "../../content/subjects/english/courses/our-world/level-2/unit-7/vocabulary.json";
import level2Unit5Vocabulary from "../../content/subjects/english/courses/our-world/level-2/unit-5/vocabulary.json";
import level2Unit6Vocabulary from "../../content/subjects/english/courses/our-world/level-2/unit-6/vocabulary.json";
...
import level5Unit2Grammar from "../../content/subjects/english/courses/our-world/level-5/unit-2/grammar.json";
...
import level1Unit5Grammar from "../../content/subjects/english/courses/our-world/level-1/unit-5/grammar.json";
import level1Unit6Grammar from "../../content/subjects/english/courses/our-world/level-1/unit-6/grammar.json";
import level1Unit7Grammar from "../../content/subjects/english/courses/our-world/level-1/unit-7/grammar.json";
import level1Unit8Grammar from "../../content/subjects/english/courses/our-world/level-1/unit-8/grammar.json";
import level1Unit9Grammar from "../../content/subjects/english/courses/our-world/level-1/unit-9/grammar.json";
...
import level2Unit1Grammar from "../../content/subjects/english/courses/our-world/level-2/unit-1/grammar.json";
import level2Unit2Grammar from "../../content/subjects/english/courses/our-world/level-2/unit-2/grammar.json";
import level2Unit3Grammar from "../../content/subjects/english/courses/our-world/level-2/unit-3/grammar.json";
import level2Unit4Grammar from "../../content/subjects/english/courses/our-world/level-2/unit-4/grammar.json";
import level2Unit9Grammar from "../../content/subjects/english/courses/our-world/level-2/unit-9/grammar.json";
import level2Unit8Grammar from "../../content/subjects/english/courses/our-world/level-2/unit-8/grammar.json";
...
type UnitVocabularyWord =
  ...
  | (typeof level5Unit2Vocabulary.words)[number]
  ...
  | (typeof level1Unit5Vocabulary.words)[number]
  | (typeof level1Unit6Vocabulary.words)[number]
  | (typeof level1Unit7Vocabulary.words)[number]
  | (typeof level1Unit8Vocabulary.words)[number]
  | (typeof level1Unit9Vocabulary.words)[number]
  ...
  | (typeof level2Unit4Vocabulary.words)[number]
  | (typeof level2Unit8Vocabulary.words)[number]
  | (typeof level2Unit7Vocabulary.words)[number]
  | (typeof level2Unit6Vocabulary.words)[number]
  | (typeof level2Unit5Vocabulary.words)[number]
  | (typeof level3Unit2Vocabulary.words)[number]
  | (typeof level3Unit3Vocabulary.words)[number]
...
type UnitGrammarPoint =
  ...
  | (typeof level5Unit2Grammar.grammarPoints)[number]
  ...
  | (typeof level1Unit5Grammar.grammarPoints)[number]
  | (typeof level1Unit6Grammar.grammarPoints)[number]
  | (typeof level1Unit7Grammar.grammarPoints)[number]
  | (typeof level1Unit8Grammar.grammarPoints)[number]
  | (typeof level1Unit9Grammar.grammarPoints)[number]
  ...
  | (typeof level2Unit4Grammar.grammarPoints)[number]
  | (typeof level2Unit9Grammar.grammarPoints)[number]
  | (typeof level2Unit8Grammar.grammarPoints)[number]
  | (typeof level2Unit7Grammar.grammarPoints)[number]
  | (typeof level2Unit6Grammar.grammarPoints)[number]
...
export const vocabularyItems: VocabularyItem[] = mergeWordsAcrossUnits([
  ...
  level1Unit5Vocabulary.words as UnitVocabularyWord[],
  level1Unit6Vocabulary.words as UnitVocabularyWord[],
  level1Unit7Vocabulary.words as UnitVocabularyWord[],
  level1Unit8Vocabulary.words as UnitVocabularyWord[],
  level1Unit9Vocabulary.words as UnitVocabularyWord[],
  ...
  level2Unit4Vocabulary.words as UnitVocabularyWord[],
  level2Unit9Vocabulary.words as UnitVocabularyWord[],
  level2Unit8Vocabulary.words as UnitVocabularyWord[],
  level2Unit7Vocabulary.words as UnitVocabularyWord[],
  level2Unit6Vocabulary.words as UnitVocabularyWord[],
  level2Unit5Vocabulary.words as UnitVocabularyWord[],
  level5Unit1Vocabulary.words as UnitVocabularyWord[],
  level5Unit2Vocabulary.words as UnitVocabularyWord[],
...
export const unitTitles: Record<string, string> = {
  ...
  [`${level1Unit5Vocabulary.level}-${level1Unit5Vocabulary.unit}`]: level1Unit5Vocabulary.unitTitle,
  [`${level1Unit6Vocabulary.level}-${level1Unit6Vocabulary.unit}`]: level1Unit6Vocabulary.unitTitle,
  [`${level1Unit7Vocabulary.level}-${level1Unit7Vocabulary.unit}`]: level1Unit7Vocabulary.unitTitle,
  [`${level1Unit8Vocabulary.level}-${level1Unit8Vocabulary.unit}`]: level1Unit8Vocabulary.unitTitle,
  [`${level1Unit9Vocabulary.level}-${level1Unit9Vocabulary.unit}`]: level1Unit9Vocabulary.unitTitle,
  ...
  [`${level2Unit4Vocabulary.level}-${level2Unit4Vocabulary.unit}`]: level2Unit4Vocabulary.unitTitle,
  [`${level2Unit9Vocabulary.level}-${level2Unit9Vocabulary.unit}`]: level2Unit9Vocabulary.unitTitle,
  [`${level2Unit8Vocabulary.level}-${level2Unit8Vocabulary.unit}`]: level2Unit8Vocabulary.unitTitle,
  [`${level2Unit7Vocabulary.level}-${level2Unit7Vocabulary.unit}`]: level2Unit7Vocabulary.unitTitle,
  [`${level2Unit6Vocabulary.level}-${level2Unit6Vocabulary.unit}`]: level2Unit6Vocabulary.unitTitle,
  [`${level2Unit5Vocabulary.level}-${level2Unit5Vocabulary.unit}`]: level2Unit5Vocabulary.unitTitle,
  [`${level5Unit1Vocabulary.level}-${level5Unit1Vocabulary.unit}`]: level5Unit1Vocabulary.unitTitle,
  [`${level5Unit2Vocabulary.level}-${level5Unit2Vocabulary.unit}`]: level5Unit2Vocabulary.unitTitle,
...
export const level5Unit2Vocab1Items = vocabularyItems.filter(
  (item) => item.type === "vocabulary" && item.sources.some((source) => source.course === "our-world" && source.level === 5 && source.unit === 2 && source.component === "vocab-1")
);
export const level5Unit2Vocab2Items = vocabularyItems.filter(
  (item) => item.type === "vocabulary" && item.sources.some((source) => source.course === "our-world" && source.level === 5 && source.unit === 2 && source.component === "vocab-2")
);
export const level5Unit2AcademicItems = vocabularyItems.filter(
  (item) => item.type === "academic" && item.sources.some((source) => source.course === "our-world" && source.level === 5 && source.unit === 2)
);
export const level5Unit2GlossaryItems = vocabularyItems.filter(
  (item) =>
    (item.type === "content" || item.type === "related" || item.type === "glossary") &&
    item.sources.some((source) => source.course === "our-world" && source.level === 5 && source.unit === 2)
);

export const level1Unit1Vocab1Items = vocabularyItems.filter((item) => (level1Unit1Vocabulary.vocab1WordIds as string[]).includes(item.id));
export const level1Unit1Vocab2Items = vocabularyItems.filter((item) => (level1Unit1Vocabulary.vocab2WordIds as string[]).includes(item.id));
export const level1Unit1AcademicItems = vocabularyItems.filter((item) => (level1Unit1Vocabulary.academicWordIds as string[]).includes(item.id));
export const level1Unit1GlossaryItems = vocabularyItems.filter(
  (item) => (level1Unit1Vocabulary.contentWordIds as string[]).includes(item.id) || (level1Unit1Vocabulary.relatedWordIds as string[]).includes(item.id)
);

export const level1Unit2Vocab1Items = vocabularyItems.filter((item) => (level1Unit2Vocabulary.vocab1WordIds as string[]).includes(item.id));
export const level1Unit2Vocab2Items = vocabularyItems.filter((item) => (level1Unit2Vocabulary.vocab2WordIds as string[]).includes(item.id));
export const level1Unit2AcademicItems = vocabularyItems.filter((item) => (level1Unit2Vocabulary.academicWordIds as string[]).includes(item.id));
export const level1Unit2GlossaryItems = vocabularyItems.filter(
  (item) => (level1Unit2Vocabulary.contentWordIds as string[]).includes(item.id) || (level1Unit2Vocabulary.relatedWordIds as string[]).includes(item.id)
);

export const level1Unit3Vocab1Items = vocabularyItems.filter((item) => (level1Unit3Vocabulary.vocab1WordIds as string[]).includes(item.id));
export const level1Unit3Vocab2Items = vocabularyItems.filter((item) => (level1Unit3Vocabulary.vocab2WordIds as string[]).includes(item.id));
...
export const level1Unit5Vocab1Items = vocabularyItems.filter((item) => (level1Unit5Vocabulary.vocab1WordIds as string[]).includes(item.id));
export const level1Unit5Vocab2Items = vocabularyItems.filter((item) => (level1Unit5Vocabulary.vocab2WordIds as string[]).includes(item.id));
export const level1Unit5AcademicItems = vocabularyItems.filter((item) => (level1Unit5Vocabulary.academicWordIds as string[]).includes(item.id));
export const level1Unit5GlossaryItems = vocabularyItems.filter(
  (item) => (level1Unit5Vocabulary.contentWordIds as string[]).includes(item.id) || (level1Unit5Vocabulary.relatedWordIds as string[]).includes(item.id)
);

export const level1Unit6Vocab1Items = vocabularyItems.filter((item) => (level1Unit6Vocabulary.vocab1WordIds as string[]).includes(item.id));
export const level1Unit6Vocab2Items = vocabularyItems.filter((item) => (level1Unit6Vocabulary.vocab2WordIds as string[]).includes(item.id));
export const level1Unit6AcademicItems = vocabularyItems.filter((item) => (level1Unit6Vocabulary.academicWordIds as string[]).includes(item.id));
export const level1Unit6GlossaryItems = vocabularyItems.filter(
  (item) => (level1Unit6Vocabulary.contentWordIds as string[]).includes(item.id) || (level1Unit6Vocabulary.relatedWordIds as string[]).includes(item.id)
);

export const level1Unit7Vocab1Items = vocabularyItems.filter((item) => (level1Unit7Vocabulary.vocab1WordIds as string[]).includes(item.id));
export const level1Unit7Vocab2Items = vocabularyItems.filter((item) => (level1Unit7Vocabulary.vocab2WordIds as string[]).includes(item.id));
export const level1Unit7AcademicItems = vocabularyItems.filter((item) => (level1Unit7Vocabulary.academicWordIds as string[]).includes(item.id));
export const level1Unit7GlossaryItems = vocabularyItems.filter(
  (item) => (level1Unit7Vocabulary.contentWordIds as string[]).includes(item.id) || (level1Unit7Vocabulary.relatedWordIds as string[]).includes(item.id)
);

export const level1Unit8Vocab1Items = vocabularyItems.filter((item) => (level1Unit8Vocabulary.vocab1WordIds as string[]).includes(item.id));
export const level1Unit8Vocab2Items = vocabularyItems.filter((item) => (level1Unit8Vocabulary.vocab2WordIds as string[]).includes(item.id));
export const level1Unit8AcademicItems = vocabularyItems.filter((item) => (level1Unit8Vocabulary.academicWordIds as string[]).includes(item.id));
export const level1Unit8GlossaryItems = vocabularyItems.filter(
  (item) => (level1Unit8Vocabulary.contentWordIds as string[]).includes(item.id) || (level1Unit8Vocabulary.relatedWordIds as string[]).includes(item.id)
);
export const level1Unit9Vocab1Items = vocabularyItems.filter((item) => (level1Unit9Vocabulary.vocab1WordIds as string[]).includes(item.id));
export const level1Unit9Vocab2Items = vocabularyItems.filter((item) => (level1Unit9Vocabulary.vocab2WordIds as string[]).includes(item.id));
export const level1Unit9AcademicItems = vocabularyItems.filter((item) => (level1Unit9Vocabulary.academicWordIds as string[]).includes(item.id));
export const level1Unit9GlossaryItems = vocabularyItems.filter(
  (item) => (level1Unit9Vocabulary.contentWordIds as string[]).includes(item.id) || (level1Unit9Vocabulary.relatedWordIds as string[]).includes(item.id)
);
...
export const level3Unit2Vocab2Items = vocabularyItems.filter((item) => (level3Unit2Vocabulary.vocab2WordIds as string[]).includes(item.id));
export const level3Unit2AcademicItems = vocabularyItems.filter((item) => (level3Unit2Vocabulary.academicWordIds as string[]).includes(item.id));
export const level3Unit2GlossaryItems = vocabularyItems.filter(
  (item) => (level3Unit2Vocabulary.contentWordIds as string[]).includes(item.id) || (level3Unit2Vocabulary.relatedWordIds as string[]).includes(item.id)
);

export const level3Unit3Vocab1Items = vocabularyItems.filter((item) => (level3Unit3Vocabulary.vocab1WordIds as string[]).includes(item.id));
export const level3Unit3Vocab2Items = vocabularyItems.filter((item) => (level3Unit3Vocabulary.vocab2WordIds as string[]).includes(item.id));
export const level3Unit3AcademicItems = vocabularyItems.filter((item) => (level3Unit3Vocabulary.academicWordIds as string[]).includes(item.id));
export const level3Unit3GlossaryItems = vocabularyItems.filter(
  (item) => (level3Unit3Vocabulary.contentWordIds as string[]).includes(item.id) || (level3Unit3Vocabulary.relatedWordIds as string[]).includes(item.id)
);
...
export const level2Unit5Vocab1Items = vocabularyItems.filter((item) => (level2Unit5Vocabulary.vocab1WordIds as string[]).includes(item.id));
export const level2Unit5Vocab2Items = vocabularyItems.filter((item) => (level2Unit5Vocabulary.vocab2WordIds as string[]).includes(item.id));
export const level2Unit5AcademicItems = vocabularyItems.filter((item) => (level2Unit5Vocabulary.academicWordIds as string[]).includes(item.id));
export const level2Unit5GlossaryItems = vocabularyItems.filter(
  (item) => (level2Unit5Vocabulary.contentWordIds as string[]).includes(item.id) || (level2Unit5Vocabulary.relatedWordIds as string[]).includes(item.id)
);

export const level2Unit1Vocab1Items = vocabularyItems.filter((item) => (level2Unit1Vocabulary.vocab1WordIds as string[]).includes(item.id));
export const level2Unit1Vocab2Items = vocabularyItems.filter((item) => (level2Unit1Vocabulary.vocab2WordIds as string[]).includes(item.id));
export const level2Unit1AcademicItems = vocabularyItems.filter((item) => (level2Unit1Vocabulary.academicWordIds as string[]).includes(item.id));
export const level2Unit1GlossaryItems = vocabularyItems.filter(
  (item) => (level2Unit1Vocabulary.contentWordIds as string[]).includes(item.id) || (level2Unit1Vocabulary.relatedWordIds as string[]).includes(item.id)
);

export const level2Unit2Vocab1Items = vocabularyItems.filter((item) => (level2Unit2Vocabulary.vocab1WordIds as string[]).includes(item.id));
export const level2Unit2Vocab2Items = vocabularyItems.filter((item) => (level2Unit2Vocabulary.vocab2WordIds as string[]).includes(item.id));
export const level2Unit2AcademicItems = vocabularyItems.filter((item) => (level2Unit2Vocabulary.academicWordIds as string[]).includes(item.id));
export const level2Unit2GlossaryItems = vocabularyItems.filter(
  (item) => (level2Unit2Vocabulary.contentWordIds as string[]).includes(item.id) || (level2Unit2Vocabulary.relatedWordIds as string[]).includes(item.id)
);

export const level2Unit3Vocab1Items = vocabularyItems.filter((item) => (level2Unit3Vocabulary.vocab1WordIds as string[]).includes(item.id));
export const level2Unit3Vocab2Items = vocabularyItems.filter((item) => (level2Unit3Vocabulary.vocab2WordIds as string[]).includes(item.id));
export const level2Unit3AcademicItems = vocabularyItems.filter((item) => (level2Unit3Vocabulary.academicWordIds as string[]).includes(item.id));
export const level2Unit3GlossaryItems = vocabularyItems.filter(
  (item) => (level2Unit3Vocabulary.contentWordIds as string[]).includes(item.id) || (level2Unit3Vocabulary.relatedWordIds as string[]).includes(item.id)
);

export const level2Unit4Vocab1Items = vocabularyItems.filter((item) => (level2Unit4Vocabulary.vocab1WordIds as string[]).includes(item.id));
export const level2Unit4Vocab2Items = vocabularyItems.filter((item) => (level2Unit4Vocabulary.vocab2WordIds as string[]).includes(item.id));
export const level2Unit4AcademicItems = vocabularyItems.filter((item) => (level2Unit4Vocabulary.academicWordIds as string[]).includes(item.id));
export const level2Unit4GlossaryItems = vocabularyItems.filter(
  (item) => (level2Unit4Vocabulary.contentWordIds as string[]).includes(item.id) || (level2Unit4Vocabulary.relatedWordIds as string[]).includes(item.id)
);

export const level2Unit6Vocab1Items = vocabularyItems.filter((item) => (level2Unit6Vocabulary.vocab1WordIds as string[]).includes(item.id));
export const level2Unit6Vocab2Items = vocabularyItems.filter((item) => (level2Unit6Vocabulary.vocab2WordIds as string[]).includes(item.id));
export const level2Unit6AcademicItems = vocabularyItems.filter((item) => (level2Unit6Vocabulary.academicWordIds as string[]).includes(item.id));
export const level2Unit6GlossaryItems = vocabularyItems.filter(
  (item) => (level2Unit6Vocabulary.contentWordIds as string[]).includes(item.id) || (level2Unit6Vocabulary.relatedWordIds as string[]).includes(item.id)
);
...
export const level2Unit8Vocab1Items = vocabularyItems.filter((item) => (level2Unit8Vocabulary.vocab1WordIds as string[]).includes(item.id));
export const level2Unit8Vocab2Items = vocabularyItems.filter((item) => (level2Unit8Vocabulary.vocab2WordIds as string[]).includes(item.id));
export const level2Unit8AcademicItems = vocabularyItems.filter((item) => (level2Unit8Vocabulary.academicWordIds as string[]).includes(item.id));
export const level2Unit8GlossaryItems = vocabularyItems.filter(
  (item) => (level2Unit8Vocabulary.contentWordIds as string[]).includes(item.id) || (level2Unit8Vocabulary.relatedWordIds as string[]).includes(item.id)
);

export const level2Unit7Vocab1Items = vocabularyItems.filter((item) => (level2Unit7Vocabulary.vocab1WordIds as string[]).includes(item.id));
export const level2Unit7Vocab2Items = vocabularyItems.filter((item) => (level2Unit7Vocabulary.vocab2WordIds as string[]).includes(item.id));
export const level2Unit7AcademicItems = vocabularyItems.filter((item) => (level2Unit7Vocabulary.academicWordIds as string[]).includes(item.id));
export const level2Unit7GlossaryItems = vocabularyItems.filter(
  (item) => (level2Unit7Vocabulary.contentWordIds as string[]).includes(item.id) || (level2Unit7Vocabulary.relatedWordIds as string[]).includes(item.id)
);
...
export const grammarPoints: GrammarPoint[] = [
  ...
  ...level5Unit2Grammar.grammarPoints.map(toGrammarPoint),
  ...
  ...level1Unit5Grammar.grammarPoints.map(toGrammarPoint),
  ...level1Unit6Grammar.grammarPoints.map(toGrammarPoint),
  ...level1Unit7Grammar.grammarPoints.map(toGrammarPoint),
  ...level1Unit8Grammar.grammarPoints.map(toGrammarPoint),
  ...level1Unit9Grammar.grammarPoints.map(toGrammarPoint),
  ...
  ...level2Unit4Grammar.grammarPoints.map(toGrammarPoint),
  ...level2Unit9Grammar.grammarPoints.map(toGrammarPoint),
  ...level2Unit8Grammar.grammarPoints.map(toGrammarPoint),
  ...level2Unit7Grammar.grammarPoints.map(toGrammarPoint),
  ...level2Unit6Grammar.grammarPoints.map(toGrammarPoint),
...
export const level1Unit5GrammarItems = grammarPoints.filter((item) => item.level === 1 && item.unit === 5);
export const level1Unit6GrammarItems = grammarPoints.filter((item) => item.level === 1 && item.unit === 6);
export const level1Unit7GrammarItems = grammarPoints.filter((item) => item.level === 1 && item.unit === 7);
export const level1Unit8GrammarItems = grammarPoints.filter((item) => item.level === 1 && item.unit === 8);
export const level1Unit9GrammarItems = grammarPoints.filter((item) => item.level === 1 && item.unit === 9);
...
export const level2Unit1GrammarItems = grammarPoints.filter((item) => item.level === 2 && item.unit === 1);
export const level2Unit2GrammarItems = grammarPoints.filter((item) => item.level === 2 && item.unit === 2);
export const level2Unit3GrammarItems = grammarPoints.filter((item) => item.level === 2 && item.unit === 3);
export const level2Unit4GrammarItems = grammarPoints.filter((item) => item.level === 2 && item.unit === 4);
export const level2Unit9GrammarItems = grammarPoints.filter((item) => item.level === 2 && item.unit === 9);
export const level2Unit8GrammarItems = grammarPoints.filter((item) => item.level === 2 && item.unit === 8);
export const level2Unit7GrammarItems = grammarPoints.filter((item) => item.level === 2 && item.unit === 7);
export const level2Unit6GrammarItems = grammarPoints.filter((item) => item.level === 2 && item.unit === 6);
